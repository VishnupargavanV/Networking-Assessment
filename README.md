...
Switches for local connectivity

A router to connect different networks

A simulated internet/cloud environment
...
Configured router interfaces for internal (LAN) and external (WAN) communication

Set default gateways for end devices

Implemented routing to enable communication between networks
...
Verified routing paths and communication across networks

Observed packet flow and address resolution using Wireshark
...
Importance of routing in enabling communication between networks

Role of ARP in resolving IP addresses to MAC addresses

NAT as a method to allow private networks to access the internet
